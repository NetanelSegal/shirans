...
const errorMessagesMap: Record<string, string | ((...args: unknown[]) => string)> = {
  ...
  [ERROR_KEYS.VALIDATION.IMAGES_NOT_BELONG_TO_PROJECT]: (...args: unknown[]) => {
  ...
  [ERROR_KEYS.SERVER.DELETE_PROJECT_IMAGES_FAILED]: 'Failed to delete project images',
};
...
function buildErrorMessages(errorKeys: any, messagesMap: Record<string, any>): any {
  const result: any = {};
