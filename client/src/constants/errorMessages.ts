...
export const ERROR_MESSAGES = {
  ...
  [ERROR_KEYS.VALIDATION.PASSWORD_TOO_SHORT]: 'הסיסמה חייבת להכיל לפחות 8 תווים',
  [ERROR_KEYS.VALIDATION.PASSWORD_WEAK]: 'הסיסמה חלשה מדי',
  [ERROR_KEYS.VALIDATION.IMAGES_NOT_BELONG_TO_PROJECT]: 'תמונות לא שייכות לפרויקט',
  ...
  [ERROR_KEYS.CONFLICT.EMAIL_ALREADY_EXISTS]: 'כתובת אימייל זו כבר רשומה במערכת',
  [ERROR_KEYS.CONFLICT.PROJECT_TITLE_EXISTS]: 'פרויקט עם שם זה כבר קיים',
  [ERROR_KEYS.NETWORK.CONNECTION_ERROR]: 'בעיית חיבור. אנא בדוק את החיבור לאינטרנט',
  ...
  [ERROR_KEYS.SERVER.REFRESH_TOKEN_FAILED]: 'רענון ההתחברות נכשל. אנא התחבר שוב',
  [ERROR_KEYS.SERVER.FETCH_PROJECTS_FAILED]: 'לא ניתן לטעון את הפרויקטים',
  [ERROR_KEYS.SERVER.FETCH_FAVOURITE_PROJECTS_FAILED]: 'לא ניתן לטעון את הפרויקטים המועדפים',
