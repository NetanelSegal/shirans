...
export const ERROR_MESSAGES = {
  ...
  'NOT_FOUND.ARTICLE_NOT_FOUND': 'המאמר לא נמצא',
  'VALIDATION.NO_IMAGE_SUPPLIED': 'לא נבחרה תמונה',
  'SERVER.ARTICLE.SLUG_FAILED': 'לא ניתן ליצור כתובת מהכותרת הזו',
  'SERVER.ARTICLE.CREATE_FAILED': 'יצירת המאמר נכשלה',
  'SERVER.ARTICLE.UPDATE_FAILED': 'עדכון המאמר נכשל',
  'SERVER.ARTICLE.DELETE_FAILED': 'מחיקת המאמר נכשלה',
  'SERVER.ARTICLE.FETCHS_FAILED': 'טעינת המאמרים נכשלה',
  'SERVER.ARTICLE.FETCH_BY_ID_FAILED': 'טעינת המאמר נכשלה',
  ...
  'SERVER.TESTIMONIAL.UPDATE_ORDER_FAILED': 'שגיאת שרת',
