...
export function ImagePanelSection({
  ...
  return (
    <section
      ...
      className={`grid grid-cols-1 overflow-hidden rounded-2xl ${columns} ${minHeight}`}
    >
      ...
      <div className="flex flex-col justify-center bg-secondary p-8 md:p-10 lg:p-8 xl:p-12">
        {children}
      </div>
    </section>
  );
