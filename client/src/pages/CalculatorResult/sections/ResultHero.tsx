...
export function ResultHero({ estimate }: { estimate: CostRange }) {
  return (
    <section className="grid grid-cols-1 items-stretch gap-0 overflow-hidden rounded-2xl lg:grid-cols-2">
      ...
      {/* Padding eases off at `lg`, where the two-column split is at its
          narrowest and the amount below needs the room more than the margin
          does. */}
      <div className="bg-secondary p-8 md:p-10 lg:p-8 xl:p-12">
