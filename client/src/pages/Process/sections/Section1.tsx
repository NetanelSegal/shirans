export default function Section1() {
  return (
    <div className='horizontal-page-padding relative'>
      {/* text container */}
      <h3 className='heading'>שיחת תיאום ציפיות </h3>
      <p className='paragraph'>
        ...
        או לא, נרד עד לפרטים{' '}
        <span className='font-bold leading-tight text-primary'>הכי קטנים</span>{' '}
