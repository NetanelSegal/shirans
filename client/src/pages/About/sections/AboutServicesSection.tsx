  ...
  return (
    ...
    >
      <h2
        ...
        className="text-h2 mb-12 text-center font-semibold"
      >
        {aboutServices.title}
      </h2>
      ...
      <div
        ref={gridRef}
        className="mx-auto max-w-4xl overflow-hidden rounded-panel border border-line"
      >
        <div className="grid grid-cols-2 gap-px md:grid-cols-4 bg-line">
          {aboutServices.items.map(({ id, icon, title }, i) => (
            ...
            >
              <div className="flex h-full flex-col items-center justify-center bg-surface-raised p-6 text-center md:p-8">
                <div className="mb-3 flex h-14 w-14 items-center justify-center">
                  <i
                    className={`fa-solid ${icon} text-2xl text-accent`}
                    aria-hidden
                  />
                </div>
