...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(
  ({ label, error, id, className, ...props }, ref) => {
    ...
    const boxClassName = [
      'flex h-5 w-5 shrink-0 items-center justify-center rounded-field border transition-colors',
      '[-webkit-tap-highlight-color:transparent]',
      'bg-surface-raised peer-checked:border-primary peer-checked:bg-primary',
      'hover-capable:border-line peer-checked:hover-capable:border-primary',
      error
        ? 'border-danger peer-focus-visible:ring-2 peer-focus-visible:ring-danger peer-focus-visible:ring-offset-0'
        : 'border-line/70 peer-focus-visible:ring-2 peer-focus-visible:ring-primary peer-focus-visible:ring-offset-0',
