...
exports.ERROR_KEYS = {
    ...
    SERVER: {
        ...
        UPLOAD_IMAGES_FAILED: 'SERVER.UPLOAD_IMAGES_FAILED',
        DELETE_MAIN_IMAGE_FAILED: 'SERVER.DELETE_MAIN_IMAGE_FAILED',
        DELETE_PROJECT_IMAGES_FAILED: 'SERVER.DELETE_PROJECT_IMAGES_FAILED',
    },
    NETWORK: {
 ...
 */
function formatErrorMessage(map, key) {
    const entry = map[key];
