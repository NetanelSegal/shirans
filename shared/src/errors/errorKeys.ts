...
export const ERROR_KEYS = {
  ...
  VALIDATION: {
    ...
    BUILT_AREA_OUT_OF_RANGE: 'VALIDATION.BUILT_AREA_OUT_OF_RANGE',
    INVALID_FILE_TYPE: 'VALIDATION.INVALID_FILE_TYPE',
    NO_IMAGE_SUPPLIED: 'VALIDATION.NO_IMAGE_SUPPLIED',
    FILE_TOO_LARGE: 'VALIDATION.FILE_TOO_LARGE',
    TOO_MANY_FILES: 'VALIDATION.TOO_MANY_FILES',
    REORDER_IMAGE_IDS_INVALID: 'VALIDATION.REORDER_IMAGE_IDS_INVALID',
    UPLOAD_METADATA_FILE_COUNT_MISMATCH:
      'VALIDATION.UPLOAD_METADATA_FILE_COUNT_MISMATCH',
    MAIN_IMAGE_ALREADY_EXISTS: 'VALIDATION.MAIN_IMAGE_ALREADY_EXISTS',
  },
  NOT_FOUND: {
  ...
  CONFLICT: {
    ...
    TOKEN_ALREADY_EXISTS: 'CONFLICT.TOKEN_ALREADY_EXISTS',
    CATEGORY_URL_CODE_EXISTS: 'CONFLICT.CATEGORY_URL_CODE_EXISTS',
    CATEGORY_HAS_ASSOCIATED_PROJECTS:
      'CONFLICT.CATEGORY_HAS_ASSOCIATED_PROJECTS',
  },
  SERVER: {
    REFRESH_TOKEN: {
      CREATE_FAILED: 'SERVER.REFRESH_TOKEN.CREATE_FAILED',
      REVOKE_FAILED: 'SERVER.REFRESH_TOKEN.REVOKE_FAILED',
      PROCESS_FAILED: 'SERVER.REFRESH_TOKEN.PROCESS_FAILED',
    },
    USER: {
      ...
      FETCH_USERS_FAILED: 'SERVER.USER.FETCH_USERS_FAILED',
    ...
    PROJECT: {
      ...
      UPLOAD_IMAGES_FAILED: 'SERVER.PROJECT.UPLOAD_IMAGES_FAILED',
      DELETE_PROJECT_IMAGES_FAILED:
        'SERVER.PROJECT.DELETE_PROJECT_IMAGES_FAILED',
      DELETE_MAIN_IMAGE_FAILED: 'SERVER.PROJECT.DELETE_MAIN_IMAGE_FAILED',
      REORDER_IMAGES_FAILED: 'SERVER.PROJECT.REORDER_IMAGES_FAILED',
      CLOUDINARY_UPLOAD_FAILED: 'SERVER.PROJECT.CLOUDINARY_UPLOAD_FAILED',
      CLOUDINARY_DELETE_FAILED: 'SERVER.PROJECT.CLOUDINARY_DELETE_FAILED',
    },

    CATEGORY: {
      CREATE_FAILED: 'SERVER.CATEGORY.CREATE_FAILED',
      UPDATE_FAILED: 'SERVER.CATEGORY.UPDATE_FAILED',
      DELETE_FAILED: 'SERVER.CATEGORY.DELETE_FAILED',
      FETCHS_FAILED: 'SERVER.CATEGORY.FETCHS_FAILED',
      FETCH_BY_ID_FAILED: 'SERVER.CATEGORY.FETCH_BY_ID_FAILED',
    },

    ARTICLE: {
      CREATE_FAILED: 'SERVER.ARTICLE.CREATE_FAILED',
      SLUG_FAILED: 'SERVER.ARTICLE.SLUG_FAILED',
      UPDATE_FAILED: 'SERVER.ARTICLE.UPDATE_FAILED',
      DELETE_FAILED: 'SERVER.ARTICLE.DELETE_FAILED',
      FETCHS_FAILED: 'SERVER.ARTICLE.FETCHS_FAILED',
      FETCH_BY_ID_FAILED: 'SERVER.ARTICLE.FETCH_BY_ID_FAILED',
    },
    TESTIMONIAL: {
      ...
      UPDATE_ORDER_FAILED: 'SERVER.TESTIMONIAL.UPDATE_ORDER_FAILED',
    },

    CALCULATOR: {
      SUBMIT_FAILED: 'SERVER.CALCULATOR.SUBMIT_FAILED',
      UPDATE_LEAD_FAILED: 'SERVER.CALCULATOR.UPDATE_LEAD_FAILED',
      DELETE_LEAD_FAILED: 'SERVER.CALCULATOR.DELETE_LEAD_FAILED',
    },
  },
  NETWORK: {
